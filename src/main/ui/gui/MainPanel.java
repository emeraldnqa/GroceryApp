...
public class MainPanel extends JPanel {
    ...
    // EFFECTS: Construct a main panel in the main frame of the app that show the app instructions, and icons
    public MainPanel() {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawLargeStringAndAddImage(g2d);
    ...
    private void generateInstructions(Graphics2D g2d, String firstline, String secondline, String thirdline,
        ...
        drawDotpointsBeforeInstructions(g2d, thirdline,180,165,190,170);

        drawDotpointsBeforeInstructions(g2d, fourthline,180,190,190,195);

        drawDotpointsBeforeInstructions(g2d, fifthline,180,215,190,220);

        drawDotpointsBeforeInstructions(g2d, sixthline,180,240,190,245);

        drawDotpointsBeforeInstructions(g2d, seventhline,180,265,190,270);

        drawDotpointsBeforeInstructions(g2d, eighthline,180,290,190,295);

        drawDotpointsBeforeInstructions(g2d, ninthline,155,315,165,320);

        drawDotpointsBeforeInstructions(g2d, tenthline,180,330,190,335);

        drawDotpointsBeforeInstructions(g2d, eleventhline,180,355,190,360);

        drawDotpointsBeforeInstructions(g2d, twefthline,180,380,190,385);

        drawDotpointsBeforeInstructions(g2d, thirteenthline,180,405,190,410);
        g2d.drawString(fourteenthline,190,425);
    }

    // EFFECTS: Draw Large Strings, and add Java Icon
    private void drawLargeStringAndAddImage(Graphics2D g2d) {
